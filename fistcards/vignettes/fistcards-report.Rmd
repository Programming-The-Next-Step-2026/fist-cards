...
cognitive flexibility in young children (2-7 years old). In the task, children
...
- `R/cards.R` creates the card deck, image paths, and card look-up helper.
...
correct because it shares animal only with the target, while the "two red
