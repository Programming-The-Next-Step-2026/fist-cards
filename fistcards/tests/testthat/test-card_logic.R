...
test_that("correct_phase1_choice ignores choices with multiple shared features", {
  card1 <- list(colour = "red", animal = "frog", number = 1)
  card2 <- list(colour = "blue", animal = "snail", number = 2)
  card3 <- list(colour = "red", animal = "frog", number = 3)
...
test_that("correct_phase2_choice ignores cards with multiple shared features", {
  card1 <- list(colour = "red", animal = "frog", number = 1)
  card2 <- list(colour = "red", animal = "frog", number = 2)
  card3 <- list(colour = "red", animal = "snail", number = 1)

  expect_true(is.na(correct_phase2_choice(card1, card2, card3)))
})

test_that("correct_phase2_choice requires different shared dimensions", {
  card1 <- list(colour = "red", animal = "frog", number = 1)
  card2 <- list(colour = "blue", animal = "snail", number = 1)
  card3 <- list(colour = "yellow", animal = "chicken", number = 1)

  expect_true(is.na(correct_phase2_choice(card1, card2, card3)))
})

test_that("correct_phase2_choice requires non-special cards not to match each other", {
  card1 <- list(colour = "red", animal = "frog", number = 1)
  card2 <- list(colour = "blue", animal = "frog", number = 2)
  card3 <- list(colour = "red", animal = "snail", number = 2)
